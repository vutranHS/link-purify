...
You can use **Link Purify** in two simple ways:

### Method 1: Direct Share (Recommended)
- When you see a Shopee, Lazada, or TikTok link in any app (e.g., Facebook, Messenger, Browser).
- Tap **Share** ➡️ Select **Link Purify** from the app list.
- The app will automatically clean and open the product for you (or show the review UI depending on your settings).

### Method 2: Manual Processing
- Copy the link you want to clean.
- Open the **Link Purify** app.
- Paste the link into the **"Paste link to test"** field ➡️ Tap **Clean Link**.
- Inspect the result and tap **Open Product**.
